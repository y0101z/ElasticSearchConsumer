...
@Configuration
@EnableJpaRepositories(basePackages = "com.wf.elastic.jparepository")
@EnableElasticsearchRepositories(basePackages = "com.wf.elastic.repository")
